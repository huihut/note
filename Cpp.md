...
4. 当对一个对象调用成员函数时，编译程序先将对象的地址赋给this指针，然后调用成员函数，每次成员函数存取数据成员时，由**隐含使用this指针**。
5. 当一个成员函数被调用时，自动向它传递一个隐含的参数，该参数是一个指向这个成员函数所在的对象的指针。 
6. 在C++中，this指针被隐含地声明为: X _ const this,这意味着 \*不能给this 指针赋值_。
7. 由于this并不是一个常规变量，所以，**不能取得this的地址**。
...
> [http://blog.sina.com.cn/s/blog\_48f587a80100k630.html](http://blog.sina.com.cn/s/blog_48f587a80100k630.html)
...
> [http://genwoxuec.blog.51cto.com/1852764/503334](http://genwoxuec.blog.51cto.com/1852764/503334)

### struct和typedef struct

> [http://www.cnblogs.com/qyaizs/articles/2039101.html](http://www.cnblogs.com/qyaizs/articles/2039101.html)  
> [http://blog.csdn.net/haiou0/article/details/6877718](http://blog.csdn.net/haiou0/article/details/6877718)
